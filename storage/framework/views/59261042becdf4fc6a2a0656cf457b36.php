<div class="form-group">
    ...
    <input type="date" name="<?php echo e($field->name); ?>" value="<?php echo e(old($field->name)); ?>" class="form-control">
...
<?php /**PATH /var/www/uat.easytax.live/resources/views/components/form/fields/date.blade.php ENDPATH**/ ?>