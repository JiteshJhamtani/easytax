    ...
    <div class="container">
        <div class="footer__grid">
            ...
            <div>
                ...
                <ul class="footer__list">
                    <li><a href="{{ route('services.index') }}" class="footer__link">ITR Filing</a></li>
                    <li><a href="{{ route('services.index') }}" class="footer__link">GST Registration & Filing</a></li>
                    <li><a href="{{ route('services.index') }}" class="footer__link">Company Registration</a></li>
                    <li><a href="{{ route('services.index') }}" class="footer__link">MSME Registration</a></li>
                    <li><a href="{{ route('services.index') }}" class="footer__link">NRI Taxation</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="footer__list">
                    ...
                    <li><a href="{{ route('pages.show', 'privacy-policy') }}" class="footer__link">Privacy Policy</a></li>
                    <li><a href="{{ route('pages.show', 'terms-and-conditions') }}" class="footer__link">Terms of Service</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="footer__bottom">
            <div class="footer__copyright">
                &copy; {{ date('Y') }} Easy Tax Global IT Solutions Pvt. Ltd. All rights reserved.
            </div>
