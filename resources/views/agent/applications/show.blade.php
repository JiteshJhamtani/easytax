...
<div class="d-flex gap-2">
            ...
            {{-- DYNAMIC FORM DATA CARD (GRID VIEW) 🔥 --}}
           
           @if (!empty($application->form_data))
    @php 
        $filteredData = array_filter($application->form_data, fn($key) => !in_array($key, ['admin_username', 'admin_password']), ARRAY_FILTER_USE_KEY); 
    @endphp
    {{-- Make sure to change your @foreach loop slightly below this to use $filteredData instead of $application->form_data --}}
