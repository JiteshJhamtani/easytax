<div <?php echo e($attributes->merge(['class' => $makeCardClass()])); ?>>
    ...
    <div class="<?php echo e($makeHeaderClass()); ?>" style="<?php echo e($makeHeaderStyle()); ?>">
        ...
        <div class="widget-user-image">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($img)): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($name)): ?>
            <h3 class="widget-user-username mb-0"><?php echo e($name); ?></h3>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($desc)): ?>
...
<?php /**PATH /var/www/uat.easytax.live/vendor/jeroennoten/laravel-adminlte/resources/views/components/widget/profile-widget.blade.php ENDPATH**/ ?>