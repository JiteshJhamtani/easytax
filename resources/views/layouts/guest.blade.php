            ...
            <div class="flex flex-col md:flex-row min-h-[600px]">
                ...
                <div class="hidden md:block w-full md:w-3/5 p-6 animate-fade-in bg-[#f8faf9] dark:bg-slate-900/50">
                    <div class="grid grid-cols-2 grid-rows-3 gap-4 h-full overflow-hidden">
                        ...
                        <img src="{{ asset('assets/images/tax-pic-1.jpeg
                ') }}" alt="Accounting paperwork" class="w-full h-full object-cover transition-transform duration-700 hover:scale-105">
                        ...
                        {{-- Image 2 (Middle Left) --}}
<div class="overflow-hidden rounded-xl shadow-sm">
    <img src="{{ asset('assets/images/tax-pic-2.jpeg') }}" alt="Signing financial documents" class="w-full h-full object-cover transition-transform duration-700 hover:scale-105">
</div>
                        {{-- Image 3 (Middle Right) --}}
<div class="overflow-hidden rounded-xl shadow-sm">
    <img src="{{ asset('assets/images/tax-pic-3.jpeg') }}" alt="Financial charts on screen" class="w-full h-full object-cover transition-transform duration-700 hover:scale-105">
</div>
...
<div class="overflow-hidden rounded-xl shadow-sm">
    <img src="{{ asset('assets/images/tax-pic-4.jpeg') }}" alt="Professional consulting" class="w-full h-full object-cover transition-transform duration-700 hover:scale-105">
</div>
                    </div>
                </div>
                ...
                <div class="stagger-anim opacity-0 translate-x-5 w-full md:w-2/5 p-8 md:p-12 flex flex-col justify-center relative transition-all duration-700 ease-out bg-white text-gray-900 dark:bg-slate-800 dark:text-white">
                    <div class="max-w-sm w-full mx-auto">
                        ...
                        {{-- Inject Login/Register Form Here --}}
                        {{ $slot }}
