<?php $__env->startSection('title', 'Add New Operator'); ?>
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <form action="<?php echo e(route('admin.team.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="form-card">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="custom-input-group">
                                    ...
                                    <input type="text" name="name" class="custom-input" placeholder="e.g. John Doe" value="<?php echo e(old('name')); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="custom-input-group">
                                    ...
                                    <input type="email" name="email" class="custom-input" placeholder="operator@easytax.live" value="<?php echo e(old('email')); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="custom-input-group">
                                    ...
                                    <input type="text" name="phone" class="custom-input" placeholder="e.g. 9876543210" value="<?php echo e(old('phone')); ?>">
                                </div>
                            </div>
                    ...
                    <div class="form-footer">
                        <a href="<?php echo e(route('admin.team.index')); ?>" class="btn btn-light" style="border: 1px solid #cbd5e1; border-radius: 8px; padding: 0.5rem 1.5rem; font-weight: 600; color: #475569;">
                            Cancel
                        </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/uat.easytax.live/resources/views/admin/team/create.blade.php ENDPATH**/ ?>