...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <tbody>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($service->pricingRules) && $service->pricingRules->count() > 0): ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $service->pricingRules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                <tr>
                                                    <td>
                                                        <select name="pricing_rules[<?php echo e($index); ?>][gst_type]" class="form-control custom-input">
                                                            <option value="Any" <?php echo e(empty($rule->gst_type) || $rule->gst_type === 'Any' ? 'selected' : ''); ?>>Any</option>
                                                            <option value="regular" <?php echo e($rule->gst_type === 'regular' ? 'selected' : ''); ?>>Regular</option>
                                                            <option value="composition" <?php echo e($rule->gst_type === 'composition' ? 'selected' : ''); ?>>Composition</option>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <select name="pricing_rules[<?php echo e($index); ?>][turnover]" class="form-control custom-input">
                                                            <option value="Any" <?php echo e(empty($rule->turnover) || $rule->turnover === 'Any' ? 'selected' : ''); ?>>Any</option>
                                                            <option value="nil" <?php echo e($rule->turnover === 'nil' ? 'selected' : ''); ?>>Nil</option>
                                                            <option value="upto_35" <?php echo e($rule->turnover === 'upto_35' ? 'selected' : ''); ?>>Upto 35 Bills (Regular1)</option>
                                                            <option value="above_35" <?php echo e($rule->turnover === 'above_35' ? 'selected' : ''); ?>>Above 35 Bills (Regular2)</option>
                                                            <option value="nil_turnover" <?php echo e($rule->turnover === 'nil_turnover' ? 'selected' : ''); ?>>Nil Turnover</option>
                                                            <option value="with_turnover" <?php echo e($rule->turnover === 'with_turnover' ? 'selected' : ''); ?>>With Turnover</option>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <select name="pricing_rules[<?php echo e($index); ?>][frequency]" class="form-control custom-input">
                                                            <option value="Any" <?php echo e(empty($rule->frequency) || $rule->frequency === 'Any' ? 'selected' : ''); ?>>Any</option>
                                                            <option value="monthly" <?php echo e($rule->frequency === 'monthly' ? 'selected' : ''); ?>>Monthly</option>
                                                            <option value="quarterly" <?php echo e($rule->frequency === 'quarterly' ? 'selected' : ''); ?>>Quarterly</option>
                                                            <option value="annual" <?php echo e($rule->frequency === 'annual' ? 'selected' : ''); ?>>Annual GSTR9</option>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <select name="pricing_rules[<?php echo e($index); ?>][plan]" class="form-control custom-input">
                                                            <option value="Any" <?php echo e(empty($rule->plan) || $rule->plan === 'Any' ? 'selected' : ''); ?>>Any</option>
                                                            <option value="one_time" <?php echo e($rule->plan === 'one_time' ? 'selected' : ''); ?>>One Time</option>
                                                            <option value="yearly_12" <?php echo e($rule->plan === 'yearly_12' ? 'selected' : ''); ?>>Yearly (12 Filings/Year)</option>
                                                            <option value="yearly_4" <?php echo e($rule->plan === 'yearly_4' ? 'selected' : ''); ?>>Yearly (4 Filings/Year)</option>
                                                        </select>
                                                    </td>
                    ...
                    <?php elseif($service->slug === 'itr-filing'): ?>
                        ...
                        <?php elseif($service->slug === 'gst-annual-package'): ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $service->pricingRules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <select name="pricing_rules[<?php echo e($index); ?>][turnover]" class="form-control custom-input">
                                                            <option value="Any" <?php echo e(empty($rule->turnover) || $rule->turnover === 'Any' ? 'selected' : ''); ?>>Any</option>
                                                            <option value="less_than_15" <?php echo e($rule->turnover === 'less_than_15' ? 'selected' : ''); ?>>Less than 15</option>
                                                            <option value="more_than_15" <?php echo e($rule->turnover === 'more_than_15' ? 'selected' : ''); ?>>More than 15</option>
                                                        </select>
                                                    </td>
                                                    <td><input type="number" step="0.01" name="pricing_rules[<?php echo e($index); ?>][base_price]" class="form-control custom-input" value="<?php echo e($rule->base_price); ?>" required></td>
                                                    <td><input type="number" step="0.01" name="pricing_rules[<?php echo e($index); ?>][commission_amount]" class="form-control custom-input" value="<?php echo e($rule->commission_amount); ?>"></td>
