<?php $__env->startSection('title', 'Edit Operator'); ?>
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="mb-4">
        <a href="<?php echo e(route('admin.team.index')); ?>" class="text-muted text-decoration-none font-weight-bold">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <form action="<?php echo e(route('admin.team.update', $teamMember->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-card">
                    ...
                    <div class="form-header">
                        ...
                        <h5 class="mb-0 font-weight-bold text-dark">Edit Operator: <?php echo e($teamMember->name); ?></h5>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="custom-input-group">
                                    ...
                                    <input type="text" name="name" class="custom-input" value="<?php echo e(old('name', $teamMember->name)); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="custom-input-group">
                                    ...
                                    <input type="email" name="email" class="custom-input" value="<?php echo e(old('email', $teamMember->email)); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="custom-input-group">
                                    ...
                                    <input type="text" name="phone" class="custom-input" value="<?php echo e(old('phone', $teamMember->phone)); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <small class="text-muted d-block mt-1">Only fill this to reset access.</small>
                            </div>
                        </div>
                    </div>

                    <div class="form-footer">
                        <a href="<?php echo e(route('admin.team.index')); ?>" class="btn btn-light" style="border: 1px solid #cbd5e1; border-radius: 8px; font-weight: 600;">
                            Cancel
                        </a>
                        <button type="submit" class="btn btn-success shadow-sm" style="border-radius: 8px; padding: 0.5rem 1.5rem; font-weight: 700;">
                            <i class="fas fa-save mr-1"></i> Update Operator
                        </button>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/uat.easytax.live/resources/views/admin/team/edit.blade.php ENDPATH**/ ?>