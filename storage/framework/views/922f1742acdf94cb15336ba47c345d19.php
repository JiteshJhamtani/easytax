<?php $__env->startSection('title', isset($gift) ? 'Edit Gift' : 'Create Gift'); ?>
...
<div class="form-wrapper">
    <div class="page-header">
        <h1 class="page-title"><?php echo e(isset($gift) ? 'Edit Gift' : 'Create New Gift'); ?></h1>
    </div>
    ...
    <div class="premium-card">
        <div class="premium-card-header">
            ...
            <div>
                <p class="header-title"><?php echo e(isset($gift) ? $gift->name : 'Gift Details'); ?></p>
        ...
        <div class="premium-card-body">
            ...
            <form method="POST" id="gift-form" enctype="multipart/form-data" action="<?php echo e(isset($gift) ? route('admin.gifts.update', $gift) : route('admin.gifts.store')); ?>">
                <?php echo csrf_field(); ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($gift)): ?> <?php echo method_field('PUT'); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="custom-input <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name', $gift->name ?? '')); ?>" placeholder="e.g. iPad Pro 256GB" required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select id="period_type" name="period_type" class="custom-input <?php $__errorArgs = ['period_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['monthly' => 'Monthly', 'quarterly' => 'Quarterly', 'yearly' => 'Yearly']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <option value="<?php echo e($value); ?>" <?php if(old('period_type', $gift->period_type ?? '') === $value): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </select>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['period_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span class="invalid-feedback"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="toggle-wrap">
                                <label class="toggle-switch">
                                    <input type="checkbox" id="is_active" name="is_active" value="1" <?php if(old('is_active', $gift->is_active ?? true)): echo 'checked'; endif; ?>>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="custom-input" placeholder="Add any specific details or terms for this gift..."><?php echo e(old('description', $gift->description ?? '')); ?></textarea>
                </div>

                <div class="section-label mt-5">Visual Assets</div>

                <div class="form-group">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($gift)): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gift->hasMedia('gift_banner')): ?>
                            <div class="image-preview">
                                <img src="<?php echo e($gift->getFirstMediaUrl('gift_banner')); ?>" alt="Current image">
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="card-footer">
            <button type="submit" form="gift-form" class="btn-submit" id="submit-btn">
                <i class="fas fa-save"></i> <?php echo e(isset($gift) ? 'Save Changes' : 'Create Gift'); ?>

            </button>
            <a href="<?php echo e(route('admin.gifts.index')); ?>" class="btn-cancel">Cancel</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
...
(function() {
    ...
    // ── CONFIGURATION ──
    const services = <?php echo json_encode($services->map(fn($s) => ['id' => $s->id, 'name' => $s->name]), 512) ?>;
    const existingGroups = <?php echo json_encode(
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/uat.easytax.live/resources/views/admin/gifts/form.blade.php ENDPATH**/ ?>