...
<div class="<?php echo e($layoutHelper->makeContentWrapperClasses()); ?> iframe-mode"
     data-widget="iframe"
    ...
    <div class="nav navbar navbar-expand navbar-white navbar-light border-bottom p-0">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('adminlte.iframe.buttons.close_all', true) || config('adminlte.iframe.buttons.close_all_other', true)): ?>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu mt-0">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('adminlte.iframe.buttons.close', false)): ?>
                        <a class="dropdown-item" href="#" data-widget="iframe-close">
                            <?php echo e(__('adminlte::iframe.btn_close_active')); ?>

                        </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('adminlte.iframe.buttons.close_all', true)): ?>
                        <a class="dropdown-item" href="#" data-widget="iframe-close" data-type="all">
                            <?php echo e(__('adminlte::iframe.btn_close_all')); ?>

                        </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('adminlte.iframe.buttons.close_all_other', true)): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('adminlte.iframe.buttons.scroll_left', true)): ?>
        ...
        <ul class="navbar-nav overflow-hidden" role="tablist">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty(config('adminlte.iframe.default_tab.url'))): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('adminlte.iframe.buttons.scroll_right', true)): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('adminlte.iframe.buttons.fullscreen', true)): ?>
...
<?php /**PATH /var/www/uat.easytax.live/vendor/jeroennoten/laravel-adminlte/resources/views/partials/cwrapper/cwrapper-iframe.blade.php ENDPATH**/ ?>