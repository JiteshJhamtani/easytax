<?php $__env->startSection('title', 'Admin Dashboard | EasyTax'); ?>
    ...
    <div class="page-header">
        ...
        <div class="d-flex align-items-center" style="gap: 1rem;">
            ...
            <div class="header-date m-0">
                ...
                <?php echo e(now()->timezone('Asia/Kolkata')->format('d M Y, h:i A')); ?>
        ...
        <div class="row mb-4">
            <div class="col-xl-3 col-lg-6 col-md-6 mb-3 mb-xl-0">
                <div class="funnel-card">
                    ...
                    <div class="funnel-value" id="kpi-total_applications"><?php echo e($kpis['total_applications']); ?></div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mb-3 mb-xl-0">
                <div class="funnel-card">
                    ...
                    <div class="funnel-value" id="kpi-completed_applications"><?php echo e($kpis['completed_applications']); ?></div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mb-3 mb-xl-0">
                <div class="funnel-card">
                    ...
                    <div class="funnel-value" id="kpi-pending_applications"><?php echo e($kpis['pending_applications']); ?></div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mb-3 mb-xl-0">
                <div class="funnel-card">
                    ...
                    <div class="funnel-value" id="kpi-processed_applications"><?php echo e($kpis['processed_applications'] ?? 0); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mb-3 mb-xl-0">
                <div class="funnel-card">
                    ...
                    <div class="funnel-value" id="kpi-total_revenue">₹<?php echo e(number_format($kpis['total_revenue'], 2)); ?></div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mb-3 mb-xl-0">
                <div class="funnel-card">
                    ...
                    <div class="funnel-value" id="kpi-total_commission">₹<?php echo e(number_format($kpis['total_commission'], 2)); ?></div>
                </div>
            </div>
           ...
           <div class="col-xl-3 col-lg-6 col-md-6 mb-3 mb-xl-0">
                <div class="funnel-card">
                    ...
                    <div class="funnel-value" id="kpi-total_marketers"><?php echo e($kpis['total_marketers']); ?></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="dash-panel-body no-padding">
                    <div class="table-responsive">
                        <table class="mini-table">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topAgents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $agent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr>
                                    <td class="font-weight-bold text-muted"><?php echo e($i + 1); ?></td>
                                    <td>
                                        <div class="font-weight-bold" style="color: var(--slate-dark);"><?php echo e($agent->name); ?></div>
                                        <div class="code-tag mt-1" style="display:inline-block;"><?php echo e($agent->agent_code); ?></div>
                                    </td>
                                    <td class="text-center">
                                        <span class="custom-badge badge-info-soft"><?php echo e($agent->applications_count); ?></span>
                                    </td>
                                    <td class="text-right font-weight-bold" style="color: var(--green);">₹<?php echo e(number_format($agent->total_revenue, 2)); ?></td>
                                    <td class="text-right font-weight-bold" style="color: var(--slate);">₹<?php echo e(number_format($agent->commission_earned, 2)); ?></td>
                                </tr>
                ...
                <div class="dash-panel-body no-padding">
                    <div class="table-responsive">
                        <table class="mini-table">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $svc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr>
                                    <td class="font-weight-bold text-muted"><?php echo e($i + 1); ?></td>
                                    <td class="font-weight-bold" style="color: var(--slate-dark);"><?php echo e($svc->name); ?></td>
                                    <td class="text-center">
                                        <span class="custom-badge badge-info-soft"><?php echo e($svc->applications_count); ?></span>
                                    </td>
                                    <td class="text-right font-weight-bold" style="color: var(--green);">₹<?php echo e(number_format($svc->revenue, 2)); ?></td>
                                </tr>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    ...
                    <div class="table-responsive">
                        <table class="mini-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="font-weight-bold pl-4" style="color: var(--slate-dark);">#<?php echo e($app->id); ?></td>
                                    <td class="font-weight-bold text-dark"><?php echo e($app->agent->name ?? '—'); ?></td>
                                    <td><?php echo e($app->service->name ?? '—'); ?></td>
                                    <td class="text-right font-weight-bold" style="color: var(--green);">₹<?php echo e(number_format($app->amount, 2)); ?></td>
                                    <td class="text-center">
                                        <?php
                                            $statusColors = [
                                        ...
                                        ?>
                                        <span class="custom-badge <?php echo e($badgeClass); ?>"><?php echo e($statusValue); ?></span>
                                    </td>
                                    <td class="text-right text-muted pr-4"><?php echo e($app->submitted_at?->format('d M Y') ?? '—'); ?></td>
                                </tr>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<script>
    ...
    const appData = <?php echo json_encode($chartApplications, 15, 512) ?>;
    const revData = <?php echo json_encode($chartRevenue, 15, 512) ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/uat.easytax.live/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>