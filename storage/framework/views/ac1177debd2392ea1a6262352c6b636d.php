...
<?php $__env->startSection('auth_body'); ?>
    <form action="<?php echo e($registerUrl); ?>" method="post">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('adminlte::auth.auth-page', ['authType' => 'register'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/uat.easytax.live/vendor/jeroennoten/laravel-adminlte/resources/views/auth/register.blade.php ENDPATH**/ ?>