<div <?php echo e($attributes->merge(['class' => $makeProgressClass()])); ?>>
    ...
    <div class="<?php echo e($makeProgressBarClass()); ?>" role="progressbar"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($withLabel)): ?>
            <?php echo e($value); ?>%
        <?php else: ?>
...
<?php if (! $__env->hasRenderedOnce('d9e85678-d0aa-4759-b94f-7a89061235e7')): $__env->markAsRenderedOnce('d9e85678-d0aa-4759-b94f-7a89061235e7'); ?>
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /var/www/uat.easytax.live/vendor/jeroennoten/laravel-adminlte/resources/views/components/widget/progress.blade.php ENDPATH**/ ?>