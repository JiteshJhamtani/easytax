...
@section('title', 'Payout Details #' . $payout->id)
                ...
                <div class="card detail-card shadow-sm border-0 h-100">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="amount-showcase mb-4">
                            ...
                            <h2 class="amount-value text-success">₹{{ number_format($payout->amount, 2) }}</h2>
                        ...
                        <ul class="summary-list">
                            <li>
                                ...
                                <div class="sl-content">
                                    ...
                                    <span class="sl-value font-weight-bold">{{ $payout->agent->name }}</span>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div class="sl-content">
                                    ...
                                    <span
                                        class="sl-value">{{ \Carbon\Carbon::parse($payout->period_start)->format('d M Y') }}
                                        &rarr; {{ \Carbon\Carbon::parse($payout->period_end)->format('d M Y') }}</span>
                                </div>
                            </li>
                            ...
                            @if ($payout->paid_at)
                                <li>
                                    ...
                                    <div class="sl-content">
                                        ...
                                        <span
                                            class="sl-value">{{ \Carbon\Carbon::parse($payout->paid_at)->format('d M Y, h:i A') }}</span>
                                    </div>
                                </li>
                            @endif
                            ...
                            @if ($payout->notes)
                                <li class="align-items-start border-bottom-0">
                                    ...
                                    <div class="sl-content">
                                        ...
                                        <span class="sl-value text-muted font-italic">{{ $payout->notes }}</span>
                                    </div>
                                </li>
                            @endif
                        </ul>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="responsive-card-table table simple-line-table mb-0">
                                ...
                                <tbody>
                                    @forelse($payout->applications as $app)
                                        <tr>
                                            <td class="pl-4 font-weight-bold text-dark">#{{ $app->id }}</td>
                                            <td>
                                                <span
                                                    class="service-tag">{{ $app->service->name ?? 'Unknown Service' }}</span>
                                            </td>
                                            <td class="text-muted">
                                                {{ \Carbon\Carbon::parse($app->submitted_at)->format('d M Y') }}</td>
                                ...
                                @if ($payout->applications->count() > 0)
