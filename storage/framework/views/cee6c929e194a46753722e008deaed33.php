<div class="form-group">
    ...
    <div class="file-input-wrapper">
        <input type="file" name="<?php echo e($field->name); ?>" class="form-control">
        <div class="file-help">
...
<?php /**PATH /var/www/uat.easytax.live/resources/views/components/form/fields/file.blade.php ENDPATH**/ ?>