...
<head>
    ...
    <title>@yield('title', 'Marketer CRM | EasyTax')</title>
...
<div class="shell" id="shell">
    ...
    <aside class="sidebar" id="sidebar">
        <a href="{{ route('marketer.dashboard') }}" class="sb-brand">
        ...
        <nav class="sb-nav">
            ...
            <a href="{{ route('marketer.dashboard') }}" class="sb-item {{ request()->routeIs('marketer.dashboard') ? 'active' : '' }}" data-label="Dashboard">
        ...
        <header class="topbar">
            <div style="display: flex; align-items: center; gap: 1rem;">
                ...
                <div class="namaste-container">
                    <h2 class="namaste-text">Namaste, {{ explode(' ', Auth::user()->name ?? 'Marketer')[0] }}!</h2>
            ...
            <div class="topbar__actions">
                <div class="user-pill">
                    ...
                    <a href="{{ route('profile.edit') }}" class="user-pill__info">
                        <span class="user-pill__name">{{ Auth::user()->name ?? 'Marketer' }}</span>
