...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h1 class="m-0 text-dark font-weight-bold">Services Management</h1>
        <a href="{{ route('admin.services.create') }}" class="btn btn-primary font-weight-bold shadow-sm">
        ...
        <div class="card modern-card shadow-sm border-0">
            ...
            <div class="card-header bg-white pt-4 pb-2 border-bottom-0">
                <h3 class="card-title font-weight-bold text-dark">
                    <i class="fas fa-concierge-bell text-primary mr-2"></i> All Services
                </h3>
            </div>

            <div class="card-body">
                <table id="servicesTable" class="responsive-card-table table table-bordered table-striped modern-table w-100">
                    <thead>
                        <tr>
                            <th class="pl-3">ID</th>
                            <th>Name</th>
        ...
        $(function() {
            ...
            $('#servicesTable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'price', className: 'text-right text-success font-weight-bold', render: function(data) {
                        return '₹' + parseFloat(data).toFixed(2);
                    }},
                    { data: 'commission_display', className: 'text-center' },
                    { data: 'applications_count', className: 'text-center', render: function(data) {
                        return data ? `<span class="badge badge-info px-2 py-1">${data}</span>` : '<span class="text-muted">-</span>';
                    }},
                    { data: 'active', className: 'text-center', render: function(data) {
                        if (data) {
