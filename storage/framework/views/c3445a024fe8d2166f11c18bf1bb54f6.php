<?php $__env->startSection('title', 'Update Lead | EasyTax'); ?>
...
<div class="chq-wrapper p-4">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
        <div class="alert alert-success font-weight-bold rounded-lg shadow-sm border-0 mb-4"><?php echo e(session('success')); ?></div>
        ...
        <div class="col-md-7 mb-4">
            <div class="card border-0 shadow-sm rounded-lg h-100">
                ...
                <div class="card-body p-4">
                    <form action="<?php echo e(route('crm.leads.update', $lead->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="status" class="form-control rounded-lg font-weight-bold" style="height: 48px;">
                                ...
                                <option value="IN_DISCUSSION" <?php echo e($lead->status === 'IN_DISCUSSION' ? 'selected' : ''); ?>>In Discussion</option>
                                <option value="CONVERTED" <?php echo e($lead->status === 'CONVERTED' ? 'selected' : ''); ?>>Converted to Client</option>
                                <option value="LOST" <?php echo e($lead->status === 'LOST' ? 'selected' : ''); ?>>Lost / Not Interested</option>
                            </select>
                        </div>
        ...
        <div class="col-md-5 mb-4">
            <div class="card border-0 shadow-sm rounded-lg mb-4" style="background: #f8fafc;">
                <div class="card-body p-4">
                    ...
                    <h4 class="font-weight-bold text-dark mb-1"><?php echo e($lead->name); ?></h4>
                    <p class="text-muted mb-3"><i class="fas fa-phone-alt mr-2 text-primary"></i> <?php echo e($lead->phone); ?></p>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->email): ?>
                        <p class="text-muted mb-3"><i class="fas fa-envelope mr-2 text-primary"></i> <?php echo e($lead->email); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    <div class="d-flex justify-content-between border-top pt-3 mt-3">
                        <span class="text-muted font-weight-bold text-xs text-uppercase">Interested In</span>
                        <span class="font-weight-bold text-dark"><?php echo e($lead->service_interested ?? 'Not Specified'); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-lg">
                ...
                <div class="card-body p-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->notes): ?>
                        <div class="p-3 rounded-lg" style="background: #fdf8f6; border-left: 4px solid #f97316; white-space: pre-wrap; font-size: 0.9rem; color: #4b5563;"><?php echo e($lead->notes); ?></div>
                    <?php else: ?>
...
<?php echo $__env->make(auth()->user()->role === 'ADMIN' ? 'layouts.admin' : 'layouts.marketer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/uat.easytax.live/resources/views/admin/leads/edit.blade.php ENDPATH**/ ?>