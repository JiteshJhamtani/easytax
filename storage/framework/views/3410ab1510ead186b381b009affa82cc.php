...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'EasyTax Admin'); ?></title>
...
<div class="shell" id="shell">
    ...
    <aside class="sidebar" id="sidebar">
        <a href="<?php echo e(url('admin/dashboard')); ?>" class="sb-brand">
...
<nav class="sb-nav">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array(request()->getHost(), ['uat.easytax.live'])): ?>
                ...
                <a href="<?php echo e(url('admin/dashboard')); ?>" class="sb-item <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>" data-label="Dashboard">
                ...
                <a href="<?php echo e(route('admin.applications.index', ['type' => 'other'])); ?>" 
   class="sb-item <?php echo e(request()->routeIs('admin.applications.index') && request()->query('type', 'other') === 'other' ? 'active' : ''); ?>" 
   data-label="Other Apps">
    <span class="sb-item__icon"><i class="fas fa-folder"></i></span>
    Other Apps
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('admin.applications.index') && request()->query('type', 'other') === 'other'): ?>
...
<div class="sb-section">System</div>
    ...
    <a href="<?php echo e(route('admin.coupons.index')); ?>" class="sb-item <?php echo e(request()->routeIs('admin.coupons.*') ? 'active' : ''); ?>" data-label="Promo Campaigns">
        <span class="sb-item__icon"><i class="fas fa-ticket-alt"></i></span>
        Coupons
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('admin.coupons.*')): ?><span class="sb-item__dot"></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </a>
        ...
        <header class="topbar">
            <div style="display: flex; align-items: center; gap: 1rem;">
                ...
                <div class="namaste-container">
                    <h2 class="namaste-text">Namaste, <?php echo e(explode(' ', Auth::user()->name ?? 'Admin')[0]); ?>!</h2>
...
</html><?php /**PATH /var/www/uat.easytax.live/resources/views/layouts/admin.blade.php ENDPATH**/ ?>