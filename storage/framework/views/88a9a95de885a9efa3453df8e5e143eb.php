...
<img src="<?php echo e(asset('assets/images/logo11.png')); ?>" alt="EasyTax Logo">
        ...
        <div class="body">
            ...
            <div class="greeting">Namaste, <?php echo e($clientName ?? 'Valued Client'); ?>!</div>
            
            <p>Great news! Your application for <strong><?php echo e($application->service->name ?? 'our service'); ?></strong> has been fully processed and verified by our team.</p>
            
            <div class="status-box">
                <div class="status-row"><span class="label">App ID:</span> <span class="value">#<?php echo e($application->id); ?></span></div>
                <div class="status-row"><span class="label">Completed On:</span> <span class="value"><?php echo e(now()->format('d M Y, h:i A')); ?></span></div>
                <div class="status-row"><span class="label">Your Agent:</span> <span class="value"><?php echo e($application->agent->name ?? 'EasyTax Team'); ?></span></div>
            </div>
            
            <div class="cta-container">
                <a href="<?php echo e($trackingUrl); ?>" class="btn">View Final Status & Documents</a>
            </div>
        </div>
        ...
        <div class="promo-section">
            ...
            <a href="<?php echo e(route('services.index')); ?>" class="promo-btn">Explore All EasyTax Services &rarr;</a>
        </div>
        
        <div class="footer">
            <p>Need help? Contact your agent directly or call us at <strong><a href="tel:+917725981022">+91 77259 81022</a></strong></p>
            <p>&copy; <?php echo e(date('Y')); ?> EasyTax. All rights reserved.</p>
        </div>
    </div>
</body>
