<?php $__env->startSection('title', 'Gift Eligibility'); ?>
    ...
    <div class="filter-bar">
        <div class="filter-group">
            ...
            <select id="gift-select" class="filter-control" style="width:250px">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $gifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <option value="<?php echo e($g->id); ?>" data-period="<?php echo e($g->period_type); ?>"><?php echo e($g->name); ?></option>
        ...
        <div class="filter-group" id="wrap-year" style="display:none">
            ...
            <input type="number" id="filter-year" class="filter-control" value="<?php echo e(now()->year); ?>" min="2020" max="2099" style="width:100px">
        </div>
        ...
        <div class="filter-group" id="wrap-quarter" style="display:none">
            ...
            <select id="filter-quarter" class="filter-control" style="width:160px">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [1=>'Q1 (Jan–Mar)',2=>'Q2 (Apr–Jun)',3=>'Q3 (Jul–Sep)',4=>'Q4 (Oct–Dec)']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <option value="<?php echo e($q); ?>" <?php echo e(now()->quarter == $q ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </select>
        </div>
        ...
        <div class="filter-group" id="wrap-month" style="display:none">
            ...
            <select id="filter-month" class="filter-control" style="width:140px">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = range(1,12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <option value="<?php echo e($m); ?>" <?php echo e(now()->month == $m ? 'selected' : ''); ?>>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        const giftsData = <?php echo json_encode($giftsJson, 15, 512) ?>;
        let dt = null;
        ...
        function loadTable(gift) {
            ...
            dt = $('#eligibility-table').DataTable({
                ...
                ajax: { url: '<?php echo e(route("admin.gifts.eligibility.hub")); ?>', data: d => Object.assign(d, getParams()) },
                columns: [
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/uat.easytax.live/resources/views/admin/gifts/eligibility.blade.php ENDPATH**/ ?>