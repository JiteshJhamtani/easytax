                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($service->slug, ['gst-return-filing', 'itr-filing','gst-annual-package'])): ?>
                        <div class="card border-success mb-4 shadow-sm mt-4">
                            <div class="card-body bg-success-soft">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($service->slug === 'itr-filing'): ?>
        ...
        document.addEventListener('DOMContentLoaded', function() {
           ...
           // ── GLOBAL PROMO VARIABLES ──
            ...
            function calculateDynamicPrice() {
                ...
                let baseComm     = match ? parseFloat(match.commission_amount) : <?php echo e($service->commission_value ?? 0); ?>;
...
// ── SMART FORM HIDE/SHOW ENGINE ─────────────────────────── 
            ...
            $('#apply-promo-btn').on('click', function() {
                ...
                fetch('/agent/validate-coupon', {
                    ...
                    body: JSON.stringify({ 
                        code: codeInput,
                        service_slug: '<?php echo e($service->slug); ?>' 
                    })
                })
