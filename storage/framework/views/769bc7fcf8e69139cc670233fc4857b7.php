<?php $__env->startSection('title', 'Agent Payouts'); ?>
        ...
        $(function() {
            ...
            */
            const table = $('#payoutTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('admin.payouts.table')); ?>",
                columns: [{
                        data: 'id'
                    },
                    {
            ...
            */
            $('#previewBtn').click(function() {
                ...
                $.post("<?php echo e(route('admin.payouts.preview')); ?>", $('#generateForm').serialize())
                    .done(function(data) {
                        let html = '';
            ...
            */
            $('#generateForm').submit(function(e) {
                ...
                $.post("<?php echo e(route('admin.payouts.generate')); ?>", $(this).serialize())
                    .done(function(res) {
                        table.ajax.reload();
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/uat.easytax.live/resources/views/admin/payouts/index.blade.php ENDPATH**/ ?>