            ...
            <form action="{{ route('admin.team.update', $teamMember->id) }}" method="POST">
                ...
                <div class="form-card">
                    ...
                    <div class="form-header">
                        ...
                        <h5 class="mb-0 font-weight-bold text-dark">Edit Operator: {{ $teamMember->name }}</h5>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="custom-input-group">
                                    ...
                                    <input type="text" name="name" class="custom-input" value="{{ old('name', $teamMember->name) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="custom-input-group">
                                    ...
                                    <input type="email" name="email" class="custom-input" value="{{ old('email', $teamMember->email) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="custom-input-group">
                                    ...
                                    <input type="text" name="phone" class="custom-input" value="{{ old('phone', $teamMember->phone) }}">
                                </div>
                            </div>
                    ...
                    <div class="form-footer">
                        <a href="{{ route('admin.team.index') }}" class="btn btn-light" style="border: 1px solid #cbd5e1; border-radius: 8px; font-weight: 600;">
                            Cancel
                        </a>
