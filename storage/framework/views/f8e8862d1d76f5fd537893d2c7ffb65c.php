...
<div class="chq-wrapper">
    ...
    <div class="metric-card">
        ...
        <div class="metric-data">
            ...
            <strong class="metric-value"><?php echo e($stats->total ?? 0); ?></strong>
        </div>
    </div>
    <div class="metric-card">
        ...
        <div class="metric-data">
            ...
            <strong class="metric-value"><?php echo e($stats->pending ?? 0); ?></strong>
        </div>
    </div>
    <div class="metric-card">
        ...
        <div class="metric-data">
            ...
            <strong class="metric-value"><?php echo e($stats->failed ?? 0); ?></strong>
        </div>
    </div>
    <div class="metric-card">
        ...
        <div class="metric-data">
            ...
            <strong class="metric-value"><?php echo e($stats->monthly ?? 0); ?></strong>
        </div>
    </div>
</div>
        ...
        <div class="data-card">
                ...
                <div class="advanced-filters-toolbar">
                    <div class="filter-group">
                        ...
                        <select id="filterService" class="filter-input">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($services)): ?>
           ...
           <div class="data-card-body">
               <div class="table-responsive">
                    ...
                    <table id="applicationsTable" class="table w-100 compact-table <?php if(request()->query('type') === 'itr-filing'): ?> is-itr <?php endif; ?>">
                        <thead>
                            <tr>
                                <th>App ID</th>
                                <th>Service Type</th>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->query('type') === 'itr-filing'): ?>
                                    <th>ACK NO</th>
                                    <th>COMPUTATION</th>
                                    <th>BALANCE SHEET</th>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/applications.js')); ?>?v=<?php echo e(time()); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.agent', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/uat.easytax.live/resources/views/agent/applications/index.blade.php ENDPATH**/ ?>