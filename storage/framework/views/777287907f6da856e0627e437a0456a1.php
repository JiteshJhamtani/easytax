...
<nav class="main-header navbar
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <?php echo $__env->make('vendor.adminlte.partials.navbar.menu-item.notifications', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($layoutHelper->isRightSidebarEnabled()): ?>
...
<?php /**PATH /var/www/uat.easytax.live/resources/views/vendor/adminlte/partials/navbar/navbar.blade.php ENDPATH**/ ?>