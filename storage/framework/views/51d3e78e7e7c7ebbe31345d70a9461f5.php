<?php $__env->startSection('title', 'Payment Status | EasyTax'); ?>
    ...
    <div class="payment-wrapper">
        <div class="payment-card" id="paymentCard">
            ...
            <div class="card-body">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($application)): ?>
                    <div class="payment-meta">
                        <div class="meta-row">
                            <span class="label">Application Reference</span>
                            <span class="value">#<?php echo e($application->id); ?></span>
                        </div>
                        <div class="meta-row">
                            <span class="label">Total Amount</span>
                            <span class="value amount">₹<?php echo e(number_format($application->amount, 2)); ?></span>
                        </div>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <div class="action-area" id="actionArea" style="display:none;">
                    <a href="<?php echo e(route('agent.dashboard')); ?>" class="primary-btn">
...
<?php $__env->startSection('js'); ?>
    <script>
        const transactionId = "<?php echo e(request()->query('txn')); ?>";
        const urlStatus = "<?php echo e(request()->query('status')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.agent', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/uat.easytax.live/resources/views/agent/payment-result.blade.php ENDPATH**/ ?>