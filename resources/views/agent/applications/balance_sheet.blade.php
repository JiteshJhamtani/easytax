...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ url('agent/applications?type=itr-filing') }}" class="btn btn-outline-secondary rounded-pill">
    ...
    <form id="pdfGenerateForm" action="{{ route('agent.applications.balance-sheet.generate', $application->id) }}" method="POST">
        @csrf
