<form method="POST" action="<?php echo e(route('applications.store', $form->service()->slug)); ?>" enctype="multipart/form-data"
    class="agent-form">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-actions-sticky">
        <div class="actions-inner">
            <a href="<?php echo e(route('services.index')); ?>" class="btn btn-outline-secondary">Cancel</a>
...
<?php /**PATH /var/www/uat.easytax.live/resources/views/components/form/wrapper.blade.php ENDPATH**/ ?>