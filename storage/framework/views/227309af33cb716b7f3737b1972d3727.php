<?php $__env->startSection('title', 'My Assigned Tasks | EasyTax'); ?>
    ...
    <div class="row mb-4">
        <div class="col-lg-4 col-md-6 mb-3 mb-lg-0">  
            <div class="kpi-card kpi-blue">
                ...
                <div class="kpi-body">
                    <div class="kpi-value"><?php echo e($applications->count()); ?></div>
        ...
        <div class="col-lg-4 col-md-6 mb-3 mb-lg-0">
            <div class="kpi-card kpi-orange">
                ...
                <div class="kpi-body">
                    <div class="kpi-value">
                        <?php echo e($applications->filter(fn($app) => in_array(strtolower($app->status->value ?? $app->status), ['submitted', 'pending', 'in_progress']))->count()); ?>
        ...
        <div class="col-lg-4 col-md-6 mb-3 mb-md-0">
            <div class="kpi-card kpi-green">
                ...
                <div class="kpi-body">
                    <div class="kpi-value">
                        <?php echo e($applications->filter(fn($app) => strtolower($app->status->value ?? $app->status) === 'completed')->count()); ?>
    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-4 col-md-6 mb-3 mb-lg-0">  
            <div class="kpi-card">
                ...
                <div class="kpi-body">
                    <div class="kpi-value">₹<?php echo e(number_format($totalEarned)); ?></div>
        ...
        <div class="col-lg-4 col-md-6 mb-3 mb-md-0">
            <div class="kpi-card">
                ...
                <div class="kpi-body">
                    <div class="kpi-value <?php echo e($balanceDue > 0 ? 'text-danger' : ''); ?>">₹<?php echo e(number_format($balanceDue)); ?></div>
        ...
        <table id="teamTable" class="table w-100">
           <thead>
            ...
            <tbody>
                ...
                <tr>
                    <td class="font-weight-bold text-muted">#<?php echo e($app->id); ?></td>
                    <td class="font-weight-bold text-dark"><?php echo e($app->service->name ?? 'Unknown Service'); ?></td>
                    <td>
                        <?php 
                        ...
                        ?>
                        <span class="badge <?php echo e($badgeClass); ?> px-2 py-1 text-uppercase"><?php echo e(str_replace('_', ' ', $status)); ?></span>
                    </td>
                    <td class="text-muted"><?php echo e($app->updated_at->format('d M, Y')); ?></td>
                    <td class="text-right">
                        <a href="<?php echo e(route('team.applications.show', $app->id)); ?>" class="btn btn-sm btn-custom-view shadow-sm" style="border-radius: 6px; font-weight: 600;">
                            view </i>
                        </a>
                    </td>
                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/uat.easytax.live/resources/views/team/dashboard.blade.php ENDPATH**/ ?>