    ...
    public function datatable()
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('marketer_name', function ($lead) {
                return $lead->marketer ? e($lead->marketer->name) : '<span class="text-muted font-italic">Direct / None</span>';
            })
    ...
    public function vleDatatable()
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('contact_info', function ($lead) {
                return '<div><div class="font-weight-bold text-dark">'.e($lead->phone).'</div><div class="text-muted small">'.e($lead->email ?? '').'</div></div>';
            })
            ->addColumn('status_badge', function ($lead) {
                $colors = [
                    'NEW' => 'badge-info',
