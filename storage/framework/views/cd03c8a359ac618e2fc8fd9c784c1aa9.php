    ...
    <a class="nav-link <?php echo e($item['class']); ?> <?php if(isset($item['shift'])): ?> <?php echo e($item['shift']); ?> <?php endif; ?>"
       href="" <?php echo $item['data-compiled'] ?? ''; ?>>
        ...
        <p>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($item['label'])): ?>
...
<?php /**PATH /var/www/uat.easytax.live/vendor/jeroennoten/laravel-adminlte/src/../resources/views/partials/sidebar/menu-item-treeview-menu.blade.php ENDPATH**/ ?>