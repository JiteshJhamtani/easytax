<?php $__env->startSection('title', 'Gift Rewards | EasyTax'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid px-0">
        ...
        <div class="row" id="gifts-grid">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $giftGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <?php
                ...
                <div class="col-xl-6 col-lg-12 mb-4 gift-card-wrapper" data-period="<?php echo e($periodClass); ?>">
                    <div class="luxury-gift-card h-100">
                        ...
                        <div class="luxury-gift-image">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($imageUrl): ?>
                                <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($giftName); ?>">
                            <?php else: ?>
                        ...
                        <div class="luxury-gift-main">
                            <h4 class="luxury-gift-title" title="<?php echo e($giftName); ?>"><?php echo e(Str::limit($giftName, 40)); ?></h4>
                            <div class="luxury-gift-period mt-2">
                                <span class="period-badge"><i class="fas fa-calendar-alt mr-1"></i> <?php echo e(ucfirst($group['period_type'])); ?></span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isSingle): ?>
                        ...
                        <div class="luxury-gift-stats">
                            <div class="stat-col">
                                ...
                                <span class="stat-value text-dark"><?php echo e($targetCount); ?></span>
                            </div>
                            <div class="stat-col">
                                <span class="stat-label">Submitted</span>
                                <span class="stat-value text-dark"><?php echo e($currentCount); ?></span>
                            </div>
                            <div class="stat-col">
                                <span class="stat-label">Remaining</span>
                                <span class="stat-value text-dark"><?php echo e($remaining); ?></span>
                            </div>
                        ...
                        <div class="luxury-gift-action">
                            <button class="btn-luxury-action btn-view-gift" 
                                    ...
                                    data-milestone="<?php echo e(json_encode($milestone)); ?>"
                                    data-period="<?php echo e(ucfirst($group['period_type'])); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.agent', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/uat.easytax.live/resources/views/agent/gifts/index.blade.php ENDPATH**/ ?>