                            ...
                            <div class="row mt-3">
                                <div class="col-md-6 form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="mobile_number" class="form-control custom-input border-left-0" value="<?php echo e(old('mobile_number')); ?>" placeholder="e.g. 9876543210">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="whatsapp_no" class="form-control custom-input border-left-0" value="<?php echo e(old('whatsapp_no')); ?>" placeholder="e.g. 9876543210">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea name="address" rows="2" class="form-control custom-input border-left-0" style="height: auto;" placeholder="Enter complete address"><?php echo e(old('address')); ?></textarea>
                                    </div>
                                </div>
                            </div>
