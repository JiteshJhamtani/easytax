    ...
    <div class="max-w-lg w-full bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="p-6 md:p-8">
            <div class="mb-6 border-b pb-6">
                ...
                <p class="text-slate-600">Your application for <strong><?php echo e($application->service->name ?? 'Service'); ?></strong> is currently being processed.</p>
            </div>
            ...
            <div class="space-y-4">
                <div class="flex justify-between items-center bg-slate-50 p-4 rounded-lg border">
                    ...
                    <span class="font-bold text-slate-800">#<?php echo e($application->id); ?></span>
                </div>
                ...
                <div class="flex justify-between items-center bg-slate-50 p-4 rounded-lg border">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statusStr === 'COMPLETED'): ?>
                        <span class="px-3 py-1 bg-green-100 text-green-800 text-sm font-bold rounded-full">Completed</span>
                    <?php elseif($statusStr === 'IN_PROGRESS' || $statusStr === 'E_FILING'): ?>
                        <span class="px-3 py-1 bg-blue-100 text-blue-800 text-sm font-bold rounded-full">In Progress</span>
                    <?php else: ?>
                        <span class="px-3 py-1 bg-slate-200 text-slate-800 text-sm font-bold rounded-full"><?php echo e(str_replace('_', ' ', $statusStr)); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>

                <div class="flex justify-between items-center bg-slate-50 p-4 rounded-lg border">
                    <span class="text-sm font-semibold text-slate-500 uppercase tracking-wider">Assigned Agent</span>
                    <span class="font-bold text-slate-800"><?php echo e($application->agent->name ?? 'EasyTax Team'); ?></span>
                </div>
            </div>
...
</html><?php /**PATH /var/www/uat.easytax.live/resources/views/front/pages/applications/track.blade.php ENDPATH**/ ?>