                ...
                <div class="stagger-anim opacity-0 translate-x-5 w-full md:w-2/5 p-6 sm:p-8 md:p-12 flex flex-col justify-center relative transition-all duration-700 ease-out bg-white text-gray-900 dark:bg-slate-800 dark:text-white">
                    <div class="max-w-sm w-full mx-auto">
                        ...
                        <div class="flex flex-col items-center mb-8">
                            <img src="<?php echo e(asset('assets/images/logo11.png')); ?>" alt="Easy Tax Logo" class="h-20 sm:h-[6.5rem] w-auto object-contain" onerror="this.style.display='none'; document.getElementById('fallback-logo').classList.remove('hidden'); document.getElementById('fallback-logo').classList.add('flex');" />
