 <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const realMonths = {!! json_encode($monthlyApplications->pluck('month') ?? []) !!};
            const realTotals = {!! json_encode($monthlyApplications->pluck('total') ?? []) !!};
            
            const completedCount = {{ $stats->completed_applications ?? 0 }};
