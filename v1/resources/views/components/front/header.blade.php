<header class="header" id="mainHeader">
    <div class="container header__container">
        ...
        <div class="header__actions">
            ...
            @else
                <a href="{{ auth()->user()->role === 'ADMIN' ? route('admin.dashboard') : route('agent.dashboard') }}" class="btn btn-primary btn-sm btn-login">
    ...
    <nav class="mobile-nav" id="mobileNav" aria-hidden="true">
        <div class="container">
            ...
            <div class="mobile-nav__footer">
                ...
                @else
                    <a href="{{ auth()->user()->role === 'ADMIN' ? route('admin.dashboard') : route('agent.dashboard') }}" class="btn btn-primary w-100 btn-login">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <rect x="3" y="3" width="7" height="7"></rect>
                            <rect x="14" y="3" width="7" height="7"></rect>
                            <rect x="14" y="14" width="7" height="7"></rect>
