        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(auth()->user()->role === 'ADMIN' ? route('admin.dashboard') : route('agent.dashboard')); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => auth()->user()->role === 'ADMIN' ? route('admin.dashboard') : route('agent.dashboard'),'active' => request()->routeIs('*.dashboard')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(auth()->user()->role === 'ADMIN' ? route('admin.dashboard') : route('agent.dashboard')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('*.dashboard'))]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => auth()->user()->role === 'ADMIN' ? route('admin.dashboard') : route('agent.dashboard'),'active' => request()->routeIs('*.dashboard')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH /var/www/uat.easytax.live/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>