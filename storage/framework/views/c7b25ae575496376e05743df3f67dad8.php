...
<?php $__env->startSection('content_header'); ?>
    <div class="d-flex justify-content-between align-items-center mb-3 mt-2">
        <h1 class="m-0 text-dark font-weight-bold">Edit Page: <?php echo e($page->title); ?></h1>
        <a href="<?php echo e(route('admin.pages.index')); ?>" class="btn btn-outline-secondary font-weight-bold shadow-sm">
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="title" id="pageTitle"
                                    class="form-control custom-input border-left-0 <?php $__errorArgs = ['title'];
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('title', $page->title)); ?>" placeholder="e.g. Privacy Policy" required>
                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('slug', $page->slug)); ?>" placeholder="privacy-policy"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="form-group mb-4">
                        <div class="custom-control custom-switch custom-switch-lg">
                            <input type="checkbox" class="custom-control-input" id="isActive" name="is_active" value="1" <?php echo e(old('is_active', $page->is_active) ? 'checked' : ''); ?>>
            ...
            <div class="d-flex justify-content-end mt-4 mb-4">
                <a href="<?php echo e(route('admin.pages.index')); ?>" class="btn btn-light font-weight-bold mr-2 text-muted">
                    Cancel
                </a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/uat.easytax.live/resources/views/admin/pages/edit.blade.php ENDPATH**/ ?>