...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center mb-3 mt-2">
        <h1 class="m-0 text-dark font-weight-bold">Edit Page: {{ $page->title }}</h1>
            ...
            <div class="card modern-card border-0 shadow-sm">
                ...
                <div class="card-body pt-0 px-4 pb-4">
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="title" id="pageTitle"
                                    ...
                                    value="{{ old('title', $page->title) }}" placeholder="e.g. Privacy Policy" required>
                            </div>
                            @error('title')
                        ...
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="slug" id="pageSlug"
                                    ...
                                    value="{{ old('slug', $page->slug) }}" placeholder="privacy-policy"
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea name="content" id="pageContent" class="form-control @error('content') is-invalid @enderror">{{ old('content', $page->content) }}</textarea>
                        @error('content')
                            <span class="text-danger small font-weight-bold mt-1 d-block"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-4">
                        <div class="custom-control custom-switch custom-switch-lg">
                            <input type="checkbox" class="custom-control-input" id="isActive" name="is_active" value="1" {{ old('is_active', $page->is_active) ? 'checked' : '' }}>
