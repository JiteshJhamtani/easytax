...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'EasyTax Agent'); ?></title>
...
<div class="shell" id="shell">
    ...
    <aside class="sidebar" id="sidebar">
        <a href="<?php echo e(url('agent/dashboard')); ?>" class="sb-brand">
        ...
        <header class="topbar">
            <div style="display: flex; align-items: center; gap: 1rem;">
                ...
                <div class="namaste-container">
                    <h2 class="namaste-text">Namaste, <?php echo e(explode(' ', Auth::user()->name ?? 'Agent')[0]); ?>!</h2>
            ...
            <div class="topbar__actions">
                <div class="user-pill">
                    ...
                    <a href="<?php echo e(route('profile.edit')); ?>" class="user-pill__info">
                        <span class="user-pill__name"><?php echo e(Auth::user()->name ?? 'Agent'); ?></span>
...
</html><?php /**PATH /var/www/uat.easytax.live/resources/views/layouts/agent.blade.php ENDPATH**/ ?>