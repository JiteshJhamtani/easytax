...
@section('title', 'EasyTax | Your Tax Partner for Personalized Solutions')
        ...
        <div class="container hero-container">
            <div class="hero-content">
                ...
                <div class="hero-actions">
                    @guest
                        <a href="{{ route('login') }}" class="btn btn-primary btn-lg shadow-primary">
                            Agent Portal Login
                    ...
                    @endguest
                    <a href="{{ route('services.index') }}" class="btn btn-outline-white btn-lg">
                            ...
                            <div class="service-footer">
                                @if ($service->price > 0)
                                    <div class="service-price">
                                        ...
                                        <span class="amount">{{ money($service->price) }}</span>
                                    </div>
                                @else
                                    <div class="service-price">
                                ...
                                @endif
                                <a href="{{ route('services.show', $service->slug) }}" class="btn-link">
