...
@section('title', 'Admin Application Manager | EasyTax')

@section('content_header')
    <div class="workspace-header d-flex justify-content-between align-items-center">
        <div>
            <h1 class="workspace-title">Global Application Manager</h1>
            <p class="workspace-subtitle">Monitor, filter, and manage all agent submissions.</p>
        </div>
        <div>
            <a href="{{ route('admin.applications.export') ?? '#' }}" class="btn btn-outline-secondary bg-white shadow-sm">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="metric-card">
                    ...
                    <div class="metric-data">
                        ...
                        <strong class="metric-value">{{ $stats->completed ?? 0 }}</strong>
                    </div>
                </div>
            </div>
            ...
            <div class="card-header bg-white border-bottom-0 pt-4 px-4 pb-2">
                ...
                <div class="advanced-filters-toolbar">
                    ...
                    <div class="filter-group">
                        <label for="filterAgent">Assigned Agent</label>
                        <select id="filterAgent" class="form-control filter-input">
