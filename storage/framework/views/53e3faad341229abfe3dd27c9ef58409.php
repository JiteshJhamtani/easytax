...
<script>
    ...
    <?php if(isset($formConfig) && $formConfig): ?>
        formSchema = <?php echo json_encode($formConfig, 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/uat.easytax.live/resources/views/admin/services/partials/form-builder.blade.php ENDPATH**/ ?>