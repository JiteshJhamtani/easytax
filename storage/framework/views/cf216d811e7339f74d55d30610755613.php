<?php $__env->startSection('title', 'My Payouts'); ?>
                ...
                <div class="metric-card bg-white shadow-sm border-0 h-100"
                    ...
                    <div>
                        ...
                        <h3 class="m-0 font-weight-bold text-dark" style="font-size: 1.8rem;">
                            ₹<?php echo e(number_format($lifetimeEarnings ?? 0, 2)); ?></h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-3 mb-md-0">
                <div class="metric-card bg-white shadow-sm border-0 h-100"
                    ...
                    <div>
                        ...
                        <h3 class="m-0 font-weight-bold text-dark" style="font-size: 1.8rem;">
                            ₹<?php echo e(number_format($lastPayoutAmount ?? 0, 2)); ?></h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#payoutTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('agent.payouts.table')); ?>",
                columns: [{
                        data: 'id',
                        name: 'id',
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/uat.easytax.live/resources/views/agent/payouts/index.blade.php ENDPATH**/ ?>